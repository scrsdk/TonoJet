...
import { openFullscreen, testMobile, webpORpng } from '../../utils/aviatorUtils';
...
const Splash = ({ loaded, setOpenGame }) => {
    ...
    return (
        <div className='flex flex-col gap-10 w-full items-center text-white justify-center' style={{ height: "calc(100vh - 50px)" }}>
            <div className='flex flex-col gap-4 items-center justify-center'>
                ...
                <img alt="aviator" src={`${import.meta.env.VITE_ASSETS_IMAGE_URL || '/assets/'}${webpORpng}/aviator-text.${webpORpng}`} className='w-[200px]' />
